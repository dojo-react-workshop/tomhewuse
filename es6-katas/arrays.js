...
//         const found = [false, true].find((value, index, arr)=>{if(value===true){return value}});
//
...
//         const foundAt = [false, true].findIndex((item)=>{if(item===true){return true;}});
//
//         assert.equal(foundAt, 1);
//     });
//
//     it('returns the first position it was found at', function() {
//         const foundAt = [0, 1, 1, 1].findIndex((item) => {if(item === 1){return true;}});
//
//         assert.equal(foundAt, 1);
//     });
//
//     it('returns `-1` when nothing was found', function() {
//         const foundAt = [1, 2, 3].findIndex((item) => {if(item > 3){return true}});
//
//         assert.equal(foundAt, -1);
//     });
//
...
//         function theSecondThree(val,index, arr) {
